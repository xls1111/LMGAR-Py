...
try:
    LGAR_output = pd.read_pickle(r'D:\program\LGAR-Py\outputs\output_synth_1.pkl')
...
HYDRUS_output = pd.read_fwf(r'D:\Program Files\Hydrus1D_4.17.0140\3\1_2倍降雨\T_Level.txt',
