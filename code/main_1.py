...
# ---------------------------------------------------------------------------------------------------------------------#
precipFilename = r"D:\program\LGAR-Py\Figure\1\MLGAR-1\DATA\forcing_data_resampled_synth_1.csv"
SomeTxtFile = r"D:\program\LGAR-Py\Figure\1\MLGAR-1\sample_MLGAR_output.txt"
# ---------------------------------------------------------------------------------------------------------------------#
...
# 验证
HYDRUS_output = pd.read_fwf(r'D:\Program Files\Hydrus1D_4.17.0140\3\1_2倍降雨\T_Level.txt', widths=[13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13])
output = pd.read_pickle(r'D:\program\LGAR-Py\outputs\output_synth_1.pkl')
...
# 在右下方添加文本 "(a)"
plt.text(0.98, 0.02, '(a)', transform=plt.gca().transAxes, fontsize=12, horizontalalignment='right', verticalalignment='bottom')
...
runoff_output.to_csv(r'D:\program\LGAR-Py\Figure\1\runoff.csv', index=False, encoding='utf-8')
cummInfil_output.to_csv(r'D:\program\LGAR-Py\Figure\1\cummInfil.csv', index=False, encoding='utf-8')
plt.show()
plt.close()
